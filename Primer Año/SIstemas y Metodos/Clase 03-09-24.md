...
### Influir
- Cualquier acto o ejemplo de conducta que ocasiona un cambo de actitud o de conducta de otra persona o grupo
### Lider
- Alguein que desempeñe dos funciones basicas; las funciones relativas a las tareas, o de la solucion de problemas, y las funciones para mantener el grupo, o sociales.
- ![[Pasted image 20240903104333.png]]

### Liderazgo situacional
Es un estilo de liderazgo flexible que se enfoca en la relacion que se tiene entre cada miembro del equipo y el lider.

El diagrama se divide en 4 estilos de decisison:
*Directivo:* El lider toma decisiones.
*Persuasivo:* El lider toma la decision y explica.
*Participativo:* El lider y subordinados toma decisiones.
*Delegativo:* Los subordinados toman las decisiones.
![[Pasted image 20240903105227.png]]
### Comunicacion Organizacional 
- Proceso mediante el cual las personas tratan de compartir significados por medio de la transmision de mensajes simibolicos.
## Negociacion
- **Conflicto:** Desacuerdo sobre la asignacion de recursos escasos o choque en cuanto a metas, valores entre otro; se puede presentar a nivel organizacional o interpersonal.

- **Negociacion:** La aplicacion de las habilidades de comunicacion y las transacciones para manejar conflictos y llegar a resultados satisfactorios para las partes.ç
![[Pasted image 20240903110635.png]]